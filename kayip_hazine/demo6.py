...
class DroneController:
    def __init__(self, port="COM8", baudrate=115200):
        ...
        self.PWM_MIN = 1000
        self.PWM_MAX = 2000
        self.current_position = (36.123000, 33.123000)  # Dummy başlangıç
    ...
    def navigate_to_waypoint(self, target_lat, target_lon, speed=0.5):
        ...
        while remaining > 1.0:
            ...
            # Geçici olarak 'roll' yaw olarak kullanılıyor
            current_yaw = telemetry['roll']
            ...
            print(f"🧭 Sapma: {yaw_error:.1f}° | Mesafe: {remaining:.1f} m")
            remaining -= speed * dt
            time.sleep(0.05)
